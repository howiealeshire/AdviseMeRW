...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.schedule_tbl.setRowCount(15)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.schedule_tbl.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.schedule_tbl.setItem(1, 3, item)
    ...
    def retranslateUi(self, Dialog):
        ...
        item = self.schedule_tbl.item(1, 1)
        item.setText(_translate("Dialog", "course3"))
        item = self.schedule_tbl.item(1, 3)
        item.setText(_translate("Dialog", "course3"))
